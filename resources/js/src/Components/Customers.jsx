        ...
        <div className="p-8 bg-white min-h-screen flex-grow">
          <div className="mb-8">
            <div className="flex items-center">
              <div className="w-10 h-10 bg-gray-200 rounded mr-4 skeleton"></div>
              <div>
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="p-8 bg-white min-h-screen flex-grow">
        ...
        <div className="text-right mt-8">
          <button className="px-6 py-3 bg-green-600 text-white rounded-xl shadow-md hover:bg-green-700 hover:shadow-lg transition-all font-bold">
            Add New Customer
          </button>
        </div>
      </div>
