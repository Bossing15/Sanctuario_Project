  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        setTimeout(() => {
          setSubmitted(false);
          setFormData({ fullName: '', email: '', phone: '', productInterest: 'Columbariums', message: '', consent: false });
        }, 3000);
      } else {
      ...
      <div className="internment-inquiry">
        ...
        <form className="inquiry-form" onSubmit={handleSubmit}>
          ...
          <div className="form-row product-service-row">
            ...
            <input type="text" name="productInterest" value="Columbariums" disabled readOnly />
          </div>
          <div className="form-row">
